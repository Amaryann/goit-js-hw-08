...
gallery.insertAdjacentHTML("afterbegin", generateMarkup((0, _galleryItemsJs.galleryItems)));
const handleClick = (e)=>{
    if (e.target.nodeName === "UL") return;
    e.preventDefault();
    let lightbox = new (0, _simplelightboxDefault.default)(e.target.parentElement, {
        captionDelay: 250,
        captionsData: "alt"
    });
    lightbox.open();
